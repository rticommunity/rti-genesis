...
- See `docs/function_call_flow.md`, `docs/genesis_overview_report.md`, and `docs/agent_to_agent_communication.md` for deeper dives.
- For advanced monitoring, see `docs/unified_monitoring_system_plan.md`. 