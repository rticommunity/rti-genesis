...
CALC_SCRIPT="$PROJECT_ROOT/test_functions/calculator_service.py"
MONITOR_HELPER="$PROJECT_ROOT/run_scripts/helpers/test_monitoring.py"
AGENT_HELPER="$PROJECT_ROOT/run_scripts/helpers/test_agent.py"
