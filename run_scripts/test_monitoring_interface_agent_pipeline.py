...
async def main() -> int:
    ...
    pipeline_script = os.path.join(REPO_ROOT, "run_scripts", "run_interface_agent_service_test.sh")
    proc = subprocess.Popen(["bash", pipeline_script], stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)
