...
def load_schema() -> Dict[str, Any]:
    # Fallback to packaged static if docs path is unavailable in RC
    candidate_paths = [
        os.path.join(REPO_ROOT, "docs", "planning", "schemas", "viewer_topology.schema.json"),
        os.path.join(REPO_ROOT, "genesis_lib", "web", "static", "viewer_topology.schema.json"),
    ]
    for p in candidate_paths:
        ...
        raise FileNotFoundError("viewer_topology.schema.json not found in docs or packaged static")
