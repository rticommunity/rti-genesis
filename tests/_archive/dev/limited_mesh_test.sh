...
CALCULATOR_SERVICE_SCRIPT="$PROJECT_ROOT/test_functions/services/calculator_service.py"
TEXTPROC_SERVICE_SCRIPT="$PROJECT_ROOT/test_functions/services/text_processor_service.py"
LETTERCOUNT_SERVICE_SCRIPT="$PROJECT_ROOT/test_functions/services/letter_counter_service.py"
