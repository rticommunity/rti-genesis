INTERFACE_BETWEEN_Q_SEC=2 /Users/jason/Documents/Genesis_LIB/feature_development/interface_abstraction/start_topology.sh \
  --agents 3 \
  --services 20 \
  --interfaces 2 \
  -t 150 \
  --force \
  --service-cmd "python /Users/jason/Documents/Genesis_LIB/test_functions/calculator_service.py" \
  --extra-agent-cmd "GENESIS_TRACE_AGENTS=1 python /Users/jason/Documents/Genesis_LIB/examples/MultiAgent/agents/personal_assistant.py" \
  --extra-agent-cmd "GENESIS_TRACE_AGENTS=1 python /Users/jason/Documents/Genesis_LIB/examples/MultiAgent/agents/weather_agent.py" \
  --extra-agent-cmd "GENESIS_TRACE_AGENTS=1 python /Users/jason/Documents/Genesis_LIB/run_scripts/baseline_test_agent.py" \
  --extra-agent-cmd "GENESIS_TRACE_AGENTS=1 python /Users/jason/Documents/Genesis_LIB/run_scripts/math_test_agent.py" \
