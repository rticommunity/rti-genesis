...
def main() -> int:
    ...
    parser.add_argument("--out", type=str, default="feature_development/interface_abstraction/logs/graph_snapshot.json", help="Path to write Cytoscape JSON snapshot")
