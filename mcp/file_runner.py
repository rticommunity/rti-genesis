...
def main():
    ...
    ap.add_argument("--enqueue", choices=["preflight", "triage", "all", "active"], help="Enqueue a task and wait for result", nargs="?")
    ...
    if args.enqueue:
        ...
        # Always wait: this tool is only useful if it blocks until completion
        logger.info("Wait mode enforced: blocking until result is available")
