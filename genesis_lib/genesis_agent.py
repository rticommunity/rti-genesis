...
class GenesisAgent(ABC):
    ...
    def __init__(self, agent_name: str, base_service_name: str, 
        ...
        logger.info(f"GenesisAgent {self.agent_name} initialized with unified GenesisRPC types")
        ...
        # DESIGN NOTE:
        # The agent uses a thin direct rti.rpc + DynamicData replier here (rather than the
        # GenesisReplier wrapper) to keep Interface↔Agent control messaging minimal and to
        # preserve exact log formats and timings required by tests/monitoring. Service
        # function execution uses the higher-level GenesisReplier for consistency.
